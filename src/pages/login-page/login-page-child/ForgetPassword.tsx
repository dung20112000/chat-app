...
const ForgetPassword = () => {
    ...
    return (
        <Row className="text-center">
            ...
            <Col xs={12}>
                <p style={{fontSize: "1.2rem"}} className="w-75 mx-auto text-muted">Enter your email and we
                    will send you a link to get back into your account.</p>
            </Col>
            <Col xs={12}>
                        ...
                        (formikProps: FormikProps<IValues>) => {
                            ...
                            return (
                                <Form onSubmit={handleSubmit} className="rounded-1rem px-5">
                                    ...
                                    <Col xs={12}>
                                       <div className="d-flex justify-content-around" style={{fontSize:"1.3rem"}}>
