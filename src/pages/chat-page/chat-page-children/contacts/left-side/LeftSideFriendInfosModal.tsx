...
const LeftSideFriendInfosModal = ({ show, handleClose, _id, itemFriend }: ILeftSideUserInfoModal) => {
    ...
    if (itemFriend) {
        const { email, personalInfos: { firstName, lastName, avatarUrl, gender }, conversationsId } = itemFriend;
        return (
            <div>
                <Modal show={show}
                    onHide={handleClose}
                            ...
                            <Col xs={12} className="pb-4">
                                {
                                    conversationsId ? (
                                        ...
                                        <button type="button" onClick={() => onChat(conversationsId)} className="btn btn-primary w-25">
                                            Chat
                                        </button>
                                    )
                                }
