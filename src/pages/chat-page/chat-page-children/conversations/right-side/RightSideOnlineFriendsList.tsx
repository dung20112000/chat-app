                    ...
                    <div className="list-friend">
                        {
                            friendsListStateRedux && friendsListStateRedux.length === 0 ? (
                                <SlideRequestAddFriendCommon imageUrl="media/welcome-slides/7495.jpg" text="friends"
                                                             maxWidth="70%" hidden={false}
                                ...
                                <SlideRequestAddFriendCommon imageUrl="media/welcome-slides/5270.jpg"
                                                             text="friends online" maxWidth="100%" hidden={true}
                                                             description=""/>
                            )
                        }
                    </div>
